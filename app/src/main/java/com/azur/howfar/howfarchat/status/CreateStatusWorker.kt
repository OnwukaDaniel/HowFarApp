...
import com.azur.howfar.newtwork_viewmodel.StatusVM
...
class CreateStatusWorker(val context: Context, param: WorkerParameters) : Worker(context, param) {
    ...
    private var statusUpdateData = StatusData()
    private val statusViewModel = StatusVM()
    ...
    override fun doWork(): Result {
        pref = context.getSharedPreferences(context.getString(R.string.STATUS_DATA), Context.MODE_PRIVATE)
        ...
        statusUpdateData = Gson().fromJson(statusDataJson, StatusData::class.java)
    ...
    private fun storeImage() {
        statusViewModel.createPost(StatusData())
    }
